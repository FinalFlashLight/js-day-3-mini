...
var getAgeForAnotherCar = car.getAge.bind(anotherCar, 2017);
...
var catman = {
  ...
  bunnies: 1,
  treesClimbed: 27,
  quote: 'to cat, or not to cat. That is the question',
}

console.log(objWithFind.findProp.call(catman, 5));
...
var dogman = {
  ...
  bigreddog: 1,
  bluedog:2,
  quote: 'i am the doggening',
}

var man = objWithFilter.filter.call(dogman, [3, 2, 'i am the doggening']);
console.log(man);
console.log(man["quote"]);
/*
9. Prototypes
...
console.log(String.prototype.toUpperCase.call('qaop;vn'));
...
// Code here
var brian = new Person('Brian', 36, 165);
var briansClone = new Person('Brians\' clone', 0, 34);
brian.addWeight(12);
briansClone.addWeight(59);
